...
class User {
    ...
    public User(String username, String password, String email, double balance) {
        ...
        this.email = email;
        String accNumber = "AC" + System.currentTimeMillis(); // Simple account number generation
        this.account = new BankAccount(accNumber, balance, this);
    }
...
public class BankApp {
    ...
    public static void depositMoney(double amount, int userIndex) {
        if (amount > 0) {
            users[userIndex].getAccount().deposit(amount);
            System.out.println("\nDeposit successful! New Balance: " + users[userIndex].getAccount().getBalance());
        } else {
    ...
    public static void withdrawMoney(double amount, int userIndex) {
        if (users[userIndex].getAccount().withdraw(amount)) {
            System.out.println("\nWithdrawal successful! New Balance: " + users[userIndex].getAccount().getBalance());
        } else {
    ...
    public static void showBalance(int userIndex) {
        System.out.println("\nCurrent Balance: " + users[userIndex].getAccount().getBalance());
    }
    ...
    public static void viewAccountDetails(int userIndex) {
        ...
        System.out.println("Account Number: " + users[userIndex].getAccount().getAccountNumber());
        System.out.println("Balance: " + users[userIndex].getAccount().getBalance());
    }
